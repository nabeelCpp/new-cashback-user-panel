...
const OurVendor = () => {
  ...
  useEffect(() => {
    const loadData = () => {
      axios
        .get(`${process.env.NEXT_PUBLIC_API_URL}/userpanel/vendors`, {
          headers: {
  ...
  return (
    <>
      ...
      <Grid
        sx={{ fontWeight: "bold", display: "flex", justifyContent: "flex-end" }}
      >
        <TextField
          id="filled-search"
          label="Search"
        ...
        <TabContext value={value}>
          ...
          <TabPanel value={0}>
                    ...
                    <Card component="div" sx={{ position: "relative", mb: 7 }}>
                      ...
                      <Grid item xs={12} sx={{ px: 5, width: "100%" }}>
                        ...
                        >
                          <Button
                            variant="outlined"
                            onClick={() => window.open(c.location, "_blank")}
                          >
                            View Locations
                          </Button>
                          <Button
            ...
            <Stack spacing={2} sx={{ p: 10 }}>
              <Pagination
                count={Math.ceil(companies.length / 6)}
                page={currentPage}
                  ...
                  <Grid container>
                    ...
                    <Grid item xs={2}>
                      <Button
                        variant="outlined"
                        onClick={() =>
                          (window.location.href = `tel:${company?.telephone}`)
                        }
                      >
                        <PhoneIcon />
                        <Typography variant="p">Phone Vendor</Typography>
                      </Button>
                    </Grid>
                    <Grid item xs={2}>
                      <Button
                      ...
                      >
                        <WhatsAppIcon />
                        <Typography variant="p">Connect Whatsapp</Typography>
                      </Button>
                    </Grid>
                  </Grid>
