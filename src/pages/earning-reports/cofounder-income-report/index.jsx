...
const CofounderIncome = () => {
  ...
  useEffect(() => {
    const loadData = () => {
      ...
      if (u.co_founder == 0) {
        toast.error("You dont have co founder rights!");
        router.replace("/dashboard");
      }
      axios
        .get(
          `${process.env.NEXT_PUBLIC_API_URL}/userpanel/earning-reports/cofounder-income`,
          {
            headers: {
...
export default CofounderIncome;
